...
SPOT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.environ['Home'] + "/my_ws/my_isaaclab_ws/spot_locomotion/source/spot_locomotion/spot_locomotion/tasks/manager_based/locomotion/velocity/config/MySpot/MySpot.usd,
